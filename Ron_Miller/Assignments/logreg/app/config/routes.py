...
"""
routes['default_controller'] = 'Regs'
routes['GET']['/'] = 'Regs#index'
routes['POST']['/users/register']='Regs#register'
routes['POST']['/users/login']='Regs#login'
routes['GET']['/success'] = 'Regs#success'
"""
