...
Will it work? - not in the current state

Server.py
    - when you return to '/' it shows 'class', 'activity' and 'color'
    - extra 'result' at the end of line 29
        
HTML 
    - only has one button to select building
    - no spot for activities to go to
