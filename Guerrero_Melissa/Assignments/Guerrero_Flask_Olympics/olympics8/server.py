...
"""
Explain line 24 - 31.  
Will it work?  How, where what? why!?
So if there is a session key 'buildings' (which there is)
then the counter of gold increments according to which
building is visited. The activity is passed to the empty
array that was created for activities. A dictionary is
created of a concatenated 'activity' string describing
the actions.
"""
