...
def process():
    ...
    if request.form['building'] in buildings:
        ...
        result_dictionary = {
                                'class': ('red','green')[result > 0], # this is nasty!
...
"""
#session['activites'] is a list of dictionaries with class: either red or green a tuple is created and then red or green is chosen each time if true of false
